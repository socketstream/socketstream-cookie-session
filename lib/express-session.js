...
var debug = require('debug')('socketstream-cookie-session'); //TODO introduce in socketstream
var deprecate = require('depd')('socketstream-cookie-session'); //TODO introduce in socketstream
var parseUrl = require('parseurl');
var uid = require('uid-safe').sync //TODO introduce in socketstream
...
module.exports = function(sessionAPI) {
  debug('SocketStream + Express Session');

  var Session = sessionAPI.Session, Cookie = sessionAPI.Cookie, Store = sessionAPI.Store;
